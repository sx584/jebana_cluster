...
class jebana_ATP_MOM(IStrategy):
    ...
    def populate_entry_trend(self, df: pd.DataFrame, metadata: dict) -> pd.DataFrame:
        ...
        # Momentum nur erzwingen, wenn aktiviert
        ...
        # Modell-Trigger: mit Momentum-Gate an Buy-Region koppeln, sonst nur Cross verwenden
        if self.mom_enable.value:
            model_cond = (
                (df["buy_region"] > 0)
            ...
            model_cond = qtpylib.crossed_above(df[prediction_col], df["target_profit"])
